...
}`;function oe(d){const t=document.createElement("style");t.innerHTML=d;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let mt=!1;class st{constructor({parent:t,autoPlace:e=t===void 0,container:i,width:a,title:A="Controls",closeFolders:m=!1,injectStyles:x=!0,touchStyles:M=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",$=>{($.code==="Enter"||$.code==="Space")&&($.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(A),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),M&&this.domElement.classList.add("allow-touch-styles"),!mt&&x&&(oe(se),mt=!0),i?i.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),a&&this.domElement.style.setProperty("--width",a+"px"),this._closeFolders=m}add(t,e,i,a,A){if(Object(i)===i)return new ie(this,t,e,i);const m=t[e];switch(typeof m){case"number":return new ee(this,t,e,i,a,A);case"boolean":return new Jt(this,t,e);case"string":return new ne(this,t,e);case"function":return new it(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,m)}addColor(t,e,i=1){return new te(this,t,e,i)}addFolder(t){const e=new st({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(i=>{i instanceof it||i._name in t.controllers&&i.load(t.controllers[i._name])}),e&&t.folders&&this.folders.forEach(i=>{i._title in t.folders&&i.load(t.folders[i._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(i=>{if(!(i instanceof it)){if(i._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${i._name}"`);e.controllers[i._name]=i.save()}}),t&&this.folders.forEach(i=>{if(i._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${i._title}"`);e.folders[i._title]=i.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const i=A=>{A.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",i))};this.$children.addEventListener("transitionend",i);const a=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=a+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(i=>i.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}const re={class:"three-scene-editor"},le={class:"panel-header"},ae={key:0,class:"preload-status"},de={class:"preload-model"},he={class:"preload-progress-container"},ce={key:1,class:"loading-indicator"},ue={class:"loading-text"},pe={key:0,class:"progress-bar-container"},ge=vt({__name:"ThreeSceneEditor",props:{modelPath:{type:String,default:"/models/landscape.glb"}},setup(d){const t=I(0),e=d,i=Ht(),a=I(null),A=I(null),m=I(!0),x=I("等待加载模型..."),M=I(!1),$=I(0);let v,b,y,S,s=null,f=null,B=I(!1),u,r,p,z,H,N;const O=Wt({isPreloading:!1,currentModel:"",progress:0});let ot;const bt=()=>{if(!a.value)return;v=new Ft,v.background=new q(16115411);const o=a.value,n=o.clientWidth/o.clientHeight;b=new Lt(75,n,.1,1e3);const g=new j(0,1.5,5),h=new j(0,0,0);b.position.copy(g),H=g.clone(),N=h.clone(),y=new Dt({antialias:!0}),y.setSize(o.clientWidth,o.clientHeight),y.setPixelRatio(Math.min(window.devicePixelRatio,2)),y.shadowMap.enabled=!0,y.outputColorSpace=Pt,o.appendChild(y.domElement),S=new Rt(b,y.domElement),S.enableDamping=!0,S.dampingFactor=.05,u=new Ot(16777215,.5),v.add(u),r=new zt(16777215,1),r.position.set(5,10,5),r.castShadow=!0,r.shadow.mapSize.width=1024,r.shadow.mapSize.height=1024,v.add(r);const _=25,l=new Vt(_,64),c=new at({color:15127992,side:dt,roughness:.8,metalness:.2}),w=new ht(l,c);w.rotation.x=-Math.PI/2,w.receiveShadow=!0,v.add(w);const E=_*1.02,k=new It(_,E,64),Y=new at({color:9127187,side:dt,roughness:.9,metalness:.1}),L=new ht(k,Y);L.rotation.x=-Math.PI/2,L.position.y=-.01,L.receiveShadow=!0,v.add(L);const Z=new Bt(2);v.add(Z),At(),window.addEventListener("resize",U),Ct(),rt()},wt=o=>{if(!b||!S)return;const n=o.cameraSettings||{position:new j(0,1.5,5),target:new j(0,0,0)};T.to(b.position,{x:n.position.x,y:n.position.y,z:n.position.z,duration:1.5,ease:"power2.inOut",onUpdate:function(){b.lookAt(S.target)}}),T.to(S.target,{x:n.target.x,y:n.target.y,z:n.target.z,duration:1.5,ease:"power2.inOut",onUpdate:function(){S.update()}}),H.copy(n.position),N.copy(n.target)},At=()=>{let o="landscape";for(const n of i)if(n.path===e.modelPath){o=n.id,t.value=i.findIndex(g=>g.id===n.id);break}F.isPreloaded(o)||F.prioritizeModel(o),K(o)},K=o=>{M.value=!0,x.value="正在加载模型...",$.value=0,F.isPreloaded(o)&&(x.value="模型已预加载，正在准备..."),Yt(o,n=>{M.value=n.isLoading,x.value=n.message,$.value=n.progress},(n,g)=>{xt(n,g),t.value=i.findIndex(h=>h.id===g.id)},n=>{console.error("模型加载失败:",n),M.value=!1,x.value=n})},xt=(o,n)=>{if(s&&v.remove(s),f&&(v.remove(f),f=null),s=o.scene,!s){x.value="模型数据无效";return}wt(n);const g=[],h=[];s.traverse(D=>{if(D.isMesh&&(D.castShadow=!0,D.receiveShadow=!0,n.needsMaterialFix)){const V=D.material;let Q=!1;Array.isArray(V)?V.forEach(Mt=>{ct(Mt)&&(Q=!0)}):V&&(Q=ct(V)),Q?g.push(D):h.push(D)}}),g.forEach((D,V)=>{D.renderOrder=10+V}),h.forEach((D,V)=>{D.renderOrder=V});const l=new R().setFromObject(s).getSize(new j),w=2/Math.max(l.x,l.y,l.z)*3;s.scale.set(w,w,w);const E=w,k=new R().setFromObject(s);f=new Tt(k,new q(35071)),f.visible=B.value,v.add(f);const Y=k.min.y,L=.05;s.position.x=0,s.position.y=-Y+L,s.position.z=0;const Z=s.position.clone(),St=s.rotation.clone();s.userData.initialTransform={position:Z,rotation:St,scale:E},v.add(s),k.setFromObject(s),f&&f.updateMatrixWorld(!0),$t()},yt=()=>{t.value=(t.value+1)%i.length,K(i[t.value].id)},_t=async o=>{M.value=!0,$.value=0;const n=i[o];n&&(F.isPreloaded(n.id)?(x.value="使用预加载模型...",await new Promise(g=>setTimeout(g,300)),$.value=100):(x.value="正在加载模型...",F.prioritizeModel(n.id)))},Ct=()=>{p=new st({autoPlace:!1,width:300}),A.value&&A.value.appendChild(p.domElement);const o=p.addFolder("相机控制"),n={resetView:()=>Et()};o.add(n,"resetView").name("重置视角"),o.open();const g=p.addFolder("模型控制"),h={currentModel:i[t.value].name,switchModel:()=>yt(),showBoundingBox:B.value};g.add(h,"currentModel",i.map(c=>F.isPreloaded(c.id)?`✓ ${c.name}`:c.name)).name("当前模型").onChange(c=>{const w=c.replace("✓ ",""),E=i.findIndex(k=>k.name===w);E!==-1&&_t(E)}),g.add(h,"switchModel").name("切换到下一个模型"),g.add(h,"showBoundingBox").name("显示模型边界").onChange(c=>{B.value=c,f&&(f.visible=c)}),g.open();const _=p.addFolder("场景设置"),l={backgroundColor:"#f5e6d3",ambientIntensity:.5,directionalIntensity:1};_.addColor(l,"backgroundColor").onChange(c=>{v.background=new q(c)}),_.add(l,"ambientIntensity",0,1,.01).onChange(c=>{u.intensity=c}),_.add(l,"directionalIntensity",0,2,.01).onChange(c=>{r.intensity=c}),_.open(),setInterval(()=>{if(m.value&&g&&g.controllers&&g.controllers.length>0){const c=g.controllers[0],w=i.map(E=>F.isPreloaded(E.id)?`✓ ${E.name}`:E.name);c._values=w,c.updateDisplay()}},2e3)},$t=()=>{if(!s||!p)return;const o=p.folders.find(l=>l._title==="模型调整");o&&p.removeFolder(o);const n=p.addFolder("模型调整"),g=s.userData.initialTransform||{position:new j(0,0,0)},h={rotationY:s.rotation.y,scale:1,positionY:s.position.y-g.position.y,wireframe:!1,reset:()=>{if(!s)return;const l=s.userData.initialTransform;if(l){T.to(s.rotation,{x:l.rotation.x,y:l.rotation.y,z:l.rotation.z,duration:1.2,ease:"power2.inOut"}),T.to(s.position,{x:l.position.x,y:l.position.y,z:l.position.z,duration:1.2,ease:"power2.inOut"});const c=l.scale;T.to(s.scale,{x:c,y:c,z:c,duration:1.2,ease:"power2.inOut",onComplete:()=>{if(f){const w=new R().setFromObject(s);f.box=w,f.updateMatrixWorld(!0)}},onUpdate:()=>{const w=(s.scale.x-l.scale)/(h.scale*l.scale-l.scale),E=1-(1-h.scale)*w;h.scale=E,h.rotationY=s.rotation.y;const k=(s.position.y-l.position.y)/(h.positionY||1e-4),Y=h.positionY*(1-k);h.positionY=Y;for(const L of n.controllers)L.updateDisplay()}}),setTimeout(()=>{h.rotationY=l.rotation.y,h.scale=1,h.positionY=0;for(const w of n.controllers)w.updateDisplay()},1200)}}};n.add(h,"rotationY",0,Math.PI*2,.01).name("旋转").onChange(l=>{if(s&&(s.rotation.y=l,f)){const c=new R().setFromObject(s);f.box=c,f.updateMatrixWorld(!0)}}),n.add(h,"scale",.1,3,.01).name("大小").onChange(l=>{if(!s)return;const c=s.userData.initialTransform;if(c){const E=c.scale*l;if(s.scale.set(E,E,E),f){const k=new R().setFromObject(s),Y=k.min.y,L=h.positionY;s.position.y=-Y+.01+L,f.box=k,f.updateMatrixWorld(!0)}}}),n.add(h,"positionY",-2,2,.01).name("高度").onChange(l=>{if(!s)return;const c=s.userData.initialTransform;if(c&&(s.position.y=c.position.y+l,f)){const w=new R().setFromObject(s);f.box=w,f.updateMatrixWorld(!0)}}),n.add(h,"wireframe").name("线框模式").onChange(l=>{s&&s.traverse(c=>{c.isMesh&&(c.material.wireframe=l)})}),n.add(h,"reset").name("重置模型"),n.open();const _=p.folders.find(l=>l._title==="模型控制");_&&_.controllers&&_.controllers.length>0&&_.controllers[0].setValue(i[t.value].name)},Et=()=>{!b||!S||(T.to(b.position,{x:H.x,y:H.y,z:H.z,duration:1.5,ease:"power2.inOut"}),T.to(S.target,{x:N.x,y:N.y,z:N.z,duration:1.5,ease:"power2.inOut",onUpdate:function(){S.update()}}))},U=()=>{if(!a.value)return;const o=a.value;b.aspect=o.clientWidth/o.clientHeight,b.updateProjectionMatrix(),y.setSize(o.clientWidth,o.clientHeight)},rt=()=>{z=requestAnimationFrame(rt),S.update(),y.render(v,b)},lt=()=>{m.value=!m.value};return tt(m,()=>{a.value&&setTimeout(U,300)}),tt(()=>e.modelPath,o=>{if(o){for(const n of i)if(n.path===o){K(n.id);break}}},{immediate:!1}),tt(()=>F.getPreloadStatus(),o=>{if(O.isPreloading=o.isPreloading,O.currentModel=o.remainingModels[0]||"",O.progress=o.progress,p){const n=p.controllers.find(g=>g.property==="selectedModelIndex");if(n){const g=n._values;i.forEach((h,_)=>{const l=F.isPreloaded(h.id);g[_]=l?`${h.name} ✓`:h.name}),n.updateDisplay()}}},{deep:!0}),Gt(()=>{bt(),ot=setInterval(()=>{const o=F.getPreloadStatus();if(O.isPreloading=o.isPreloading,O.currentModel=o.remainingModels[0]||"",O.progress=o.progress,p){const n=p.controllers.find(g=>g.property==="selectedModelIndex");if(n){const g=n._values;i.forEach((h,_)=>{const l=F.isPreloaded(h.id);g[_]=l?`${h.name} ✓`:h.name}),n.updateDisplay()}}},2e3)}),Nt(()=>{if(z&&cancelAnimationFrame(z),window.removeEventListener("resize",U),p&&p.destroy(),y&&(y.dispose(),a.value)){const o=a.value.querySelector("canvas");o&&a.value.removeChild(o)}s&&(v.remove(s),s=null),clearInterval(ot),kt()}),(o,n)=>(G(),W("div",re,[C("div",{class:ut(["control-panel",{collapsed:!m.value}])},[C("div",le,[n[0]||(n[0]=C("h3",null,"控制面板",-1)),C("button",{class:"toggle-button",onClick:lt},et(m.value?"收起":"展开"),1)]),C("div",{ref_key:"controlPanelRef",ref:A,class:"gui-container"},null,512),O.isPreloading?(G(),W("div",ae,[n[1]||(n[1]=C("div",{class:"preload-header"},"后台预加载",-1)),C("div",de,et(O.currentModel||"等待中..."),1),C("div",he,[C("div",{class:"preload-progress-bar",style:pt({width:`${O.progress}%`})},null,4)])])):J("",!0)],2),m.value?J("",!0):(G(),W("button",{key:0,class:"floating-toggle-button",onClick:lt},n[2]||(n[2]=[C("span",null,"打开控制面板",-1)]))),M.value?(G(),W("div",ce,[n[3]||(n[3]=C("div",{class:"loading-spinner"},null,-1)),C("div",ue,et(x.value),1),$.value>=0?(G(),W("div",pe,[C("div",{class:"progress-bar",style:pt({width:`${$.value}%`})},null,4)])):J("",!0)])):J("",!0),C("div",{ref_key:"containerRef",ref:a,class:ut(["scene-container",{expanded:!m.value}])},null,2)]))}}),me=ft(ge,[["__scopeId","data-v-8bf1474d"]]),fe={class:"three-scene-page"},ve={class:"editor-container"},be=vt({__name:"ThreeScene",setup(d){return(t,e)=>(G(),W("div",fe,[gt(Xt(jt),{activePath:"/three-scene"}),C("div",ve,[gt(me,{modelPath:"/models/千里江山图.glb"})]),e[0]||(e[0]=C("div",{class:"page-header"},[C("h1",null,"古风场景编辑器"),C("p",null,"探索中国传统文化的三维空间")],-1))]))}}),ye=ft(be,[["__scopeId","data-v-8485cbe2"]]);export{ye as default};
