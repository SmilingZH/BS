...
const imageToMasterpieceMap: Record<number, {dynastyId: number, paintingIndex: number}> = {
  0: {dynastyId: 3, paintingIndex: 0}, // image0001 -> 隋唐五代 -> 步辇图
  1: {dynastyId: 4, paintingIndex: 1}, // image0002 -> 宋朝 -> 千里江山图
  2: {dynastyId: 4, paintingIndex: 0}, // image0003 -> 宋朝 -> 清明上河图
  3: {dynastyId: 2, paintingIndex: 0}, // image0004 -> 魏晋南北朝 -> 洛神赋图
  4: {dynastyId: 4, paintingIndex: 4}, // image0005 -> 宋朝 -> 潇湘卧游图
  5: {dynastyId: 4, paintingIndex: 3}, // image0006 -> 宋朝 -> 早春图
  6: {dynastyId: 3, paintingIndex: 1}, // image0007 -> 隋唐五代 -> 游春图
  7: {dynastyId: 4, paintingIndex: 2}, // image0008 -> 宋朝 -> 溪山行旅图
  8: {dynastyId: 3, paintingIndex: 2}, // image0009 -> 隋唐五代 -> 明皇幸蜀图
  9: {dynastyId: 2, paintingIndex: 1}, // image0010 -> 魏晋南北朝 -> 箜篌引图
  10: {dynastyId: 1, paintingIndex: 0}, // image0011 -> 秦汉 -> 马王堆帛画
  11: {dynastyId: 0, paintingIndex: 0},  // image0012 -> 先秦 -> 人面鱼纹彩陶盆
  12: {dynastyId: 5, paintingIndex: 0}, // image0013 -> 清代 -> 秋海棠图
  13: {dynastyId: 5, paintingIndex: 1}, // image0014 -> 清代 -> 九兰图
  14: {dynastyId: 5, paintingIndex: 2}  // image0015 -> 清代 -> 兰竹图
};
...
export const getImageMetadata = (index: number) => {
  ...
  if (imageInfo) {
    return {
      ...
      significance: '此作品是中国传统绘画艺术的重要代表作品之一'
    };
  }
